...
# Convert 'Social_Media_Min' and 'Lateness_Frequency' to numeric, handling non-numeric values
...
data = data.dropna(subset=['Social_Media_Min', 'Lateness_Frequency'])

# Calculate the line of best fit
x = data['Social_Media_Min']
